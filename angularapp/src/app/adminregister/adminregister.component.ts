...
@Component({
  selector: 'app-admin-register', // Replace 'app-admin-register' with your desired selector
  templateUrl: './adminregister.component.html', // Replace './adminregister.component.html' with the path to your template file
